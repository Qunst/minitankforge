...
window.TANKS = [
  ...
  {
    slug: 'kv-3',
    name: 'KV-3 (Kliment Voroshilov-3)',
    nation: 'USSR',
    era: 'WW2',
    type: 'Heavy tank',
    featured: false,
    disabled: false,
    placeholderStyle: 'dark-medium',
    image: 'assets/img/tanks/kv3-base-coat-side-detail.jpg',
    etsyUrl: 'https://www.etsy.com/shop/Quali3DPrints',
    fact: 'The KV-3 was a heavier development of the KV tank line, intended to improve armor and firepower.',
    compatibility: 'Compact hex-based tabletop play',
  },
  {
    slug: 'm10-wolverine',
