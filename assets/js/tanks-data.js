...
window.TANKS = [
  ...
  },
  {
    ...
    siteTags: ['Game-famous', 'WoT'],
    fact: 'The T29 was an American heavy tank prototype developed to answer the threat of very heavily armored German vehicles.',
    description: 'The T29 is a large American prototype heavy tank for late-war experimental collections, alternate-history battles, and players who want US armor beyond the standard Sherman-to-Pershing path. Its broad hull and long-gun silhouette give American forces a very different top-end look.',
    compatibility: 'Compact hex-based tabletop play',
  },
  {
    slug: 't30',
    name: 'T30 (Heavy Tank T30)',
    nation: 'USA',
    era: 'WW2',
    historicalStatus: 'Prototype',
    type: 'Heavy tank',
    ...
    siteTags: ['Game-famous', 'WoT'],
    fact: 'The T30 used the same heavy chassis family as the T29 but mounted a much larger 155 mm gun for heavy assault work.',
    description: 'The T30 is an American prototype heavy tank that adds a bigger-gun branch of the T29 family for experimental and alternate-history forces. It works well beside the T29, T34 Heavy Tank, and T28/T95 when you want a full spread of late American heavy designs.',
    compatibility: 'Compact hex-based tabletop play',
  },
  {
    slug: 't34-heavy-tank',
    name: 'T34 Heavy Tank (Heavy Tank T34)',
    nation: 'USA',
    era: 'WW2',
    historicalStatus: 'Prototype',
    type: 'Heavy tank',
    ...
    siteTags: ['Game-famous', 'WoT'],
    fact: 'The American T34 heavy tank grew from the T29 program and tested a 120 mm gun on the same general chassis family.',
    description: 'The T34 Heavy Tank is an American prototype heavy tank for players who want the later gun-development branch of the T29 family. It is a natural fit for experimental US lineups, late-war what-if scenarios, and collections that compare American heavy prototypes side by side.',
    compatibility: 'Compact hex-based tabletop play',
  },
  {
    slug: 'kv-5',
    name: 'KV-5 (KV-5 Heavy Tank Project)',
    nation: 'USSR',
    era: 'WW2',
    historicalStatus: 'What-if / paper project',
    type: 'Heavy tank',
    ...
    siteTags: ['Game-famous', 'WoT'],
    fact: 'The KV-5 was a very large Soviet heavy-tank project that never reached prototype construction.',
    description: 'The KV-5 is a Soviet paper-project heavy tank for late-war what-if collections, experimental lineups, and players who like oversized armor with a strong game-world reputation. It fits naturally beside KV-family vehicles, IS-series heavies, and other alternate-history designs that push Soviet armor beyond production models.',
    compatibility: 'Compact hex-based tabletop play',
  },
  {
    slug: 'kv-85',
    name: 'KV-85 (Kliment Voroshilov-85)',
    nation: 'USSR',
    era: 'WW2',
    type: 'Heavy tank',
    featured: false,
    ...
    siteTags: ['Late war', 'WoT'],
    fact: 'The KV-85 paired the KV chassis with an 85 mm gun in a new turret during the Soviet transition toward the IS series.',
    description: 'The KV-85 is a Soviet late-war heavy tank that bridges the gap between earlier KV models and the IS family. It is a strong pick for players who want Soviet forces to show that transition clearly instead of jumping straight from KV-1s to later heavy tanks.',
    compatibility: 'Compact hex-based tabletop play',
  },
  {
    slug: 'sturmtiger',
    name: 'Sturmtiger (Sturmmorser Tiger)',
    nation: 'Germany',
    era: 'WW2',
    type: 'Assault gun',
    featured: false,
